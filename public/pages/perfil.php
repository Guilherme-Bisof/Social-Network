                    ...
                    <div class="profile-actions">
                        <?php if ($perfil_id && $perfil_id != $user_id):?>
                            ...
                            <?php elseif ($amizade_status == 'pendente'):?>
                                ...
                                <?php else:?>
                                    <button class="btn-accept" onclick="aceitarPedido(<?= $amizade['id'] ?>)">Aceitar</button>
                        ...
                        <?php endif; ?>
                        <button type="submit" id= "Mensagem" class="btn-message">Mensagem</button>
                        <?php if ($perfil_id == $user_id): ?>
                            <a href="../actions/editar-perfil.php" class="btn-config" id="configuracoes">Editar Perfil</a>
                        <?php endif; ?>
                    </div>
